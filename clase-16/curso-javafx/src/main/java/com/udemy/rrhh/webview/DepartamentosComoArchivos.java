 ...
 */
public class DepartamentosComoArchivos {

    private String textoHtml;

    public DepartamentosComoArchivos(List<Departamento> departamentos) {
    ...
    public void generarArchivoPdf() throws Exception {
        ...
        String archivo =
                "src/main/resources/com/udemy/rrhh/webview/pdfjs/web/departamentos.pdf";
